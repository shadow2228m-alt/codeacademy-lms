  ...
  if (!quizId) {
    return (
        <div className="max-w-6xl mx-auto px-6 py-10">
          <h1 className="text-3xl font-black text-cyan-300 neon-text">ساحة الامتحانات — منصة الاختبارات</h1>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-xs text-zinc-400">
            المحاولة: {attempt.id.slice(0,8)} • {attempt.status === 'in_progress' ? 'قيد الحل 📝' : attempt.status === 'submitted' ? 'تم التسليم ⏳' : 'تم التصحيح ✅'}
          </div>
        </div>
